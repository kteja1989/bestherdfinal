  ...
  <div class="bg-orange-100 border border-gray-800 rounded shadow p-2">
  	<div class="flex flex-row items-center">
        ...
        <div class="flex-1 text-left md:text-center">
  			<h4 class="font-bold uppercase text-gray-900">
                @if(tenant('id') == "demo" || tenant('id') == "ybl") 
                    Herds
                @elseif(tenant('id') == "raut")
                    Stables
                @endif
  			</h4>
  			<h5 class="font-normal text-left text-sm text-gray-900">Active  {{ $herdCount }}; Ponies Alive: {{ $goatsAlive }}; Dead {{ $goatsDead }}; Ret {{ $goatsRet }}; </h5>
		</div>
  	</div>
  </div>
</div>
...
<div class="w-full md:w-1/2 xl:w-1/3 p-3">
  <div class="bg-orange-100 border border-gray-800 rounded shadow p-2">
  	<div class="flex flex-row items-center">
  		...
  		<div class="flex-1 text-right md:text-center">
  			<h5 class="font-bold uppercase text-gray-900">Facility</h5>
  			<h5 class="font-normal text-left text-1xl text-gray-600">Infrastructure: {{ $totInfraItems }}</h5>
  		</div>
  	</div>
  </div>
</div>
